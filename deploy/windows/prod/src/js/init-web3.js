...
var provider = new ethers.providers.Web3Provider(window.ethereum);// = new ethers.providers.JsonRpcProvider('http://blockchain.coinpay.cr');//new ethers.providers.InfuraProvider('rinkeby');

var contractNFT = new ethers.Contract(ContractAddressNFT, abiNFT, provider);

var etherscanTx = 'http://65.21.242.131:4000';//'https://rinkeby.etherscan.io/tx/';//'https://etherscan.io/tx/';
